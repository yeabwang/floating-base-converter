...
class TestCLI:
    ...
    def test_hex_conversion(self, capsys):
        ...
        with patch.object(sys, 'argv', ['base-converter', 'FF', '-f', '16', '-t', '10']):
            main()
            captured = capsys.readouterr()
    ...
    def test_precision_parameter(self, capsys):
        ...
        with patch.object(sys, 'argv', ['base-converter', '3.14159', '-f', '10', '-t', '2', '-p', '5']):
            main()
            captured = capsys.readouterr()
    ...
    def test_invalid_input(self, capsys):
        ...
        with patch.object(sys, 'argv', ['base-converter', '102', '-f', '2', '-t', '10']):
